 ...
 */
public class Node1HandlerInterceptor_X implements HandlerInterceptor  {
    @Override
    public boolean preHandle(Request var1, Object var3) throws Exception {
        System.out.println("节点"+var1.getNodeId()+"执行前风控。。。");
        return true;
    }
    ...
    public boolean afterCompletion(Request var1, Object var3, Exception var4) throws Exception {
        System.out.println("节点"+var1.getNodeId()+"执行后风控。。。");
        return true;
    }
